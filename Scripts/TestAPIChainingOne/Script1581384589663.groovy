...
response1 = WS.sendRequest(findTestObject('Country Info Service/ListCountries'))
...
println('The extracted country code : ' + countryCode)

GlobalVariable.countryISOCode = countryCode

WS.sendRequestAndVerify(findTestObject('Country Info Service/GetCapitalCity'))
